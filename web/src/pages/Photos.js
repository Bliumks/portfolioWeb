        ...
        <div className="col-md-6  text-center order-1 order-md-1">
          <div className="row justify-content-center">
            ...
            <div className="col-10 col-lg-8 mb-5 mb-md-0 con">
              ...
              <p className="lead">
                  From the moment, I saw an old film of my parents, I fell in love with b/w photography. Monochrome opens up a
                  completely new perspective on the everyday world and allows to rediscover it to fill it with new stories.
              </p>
            </div>
        ...
        <div className="col-md-6 text-center order-1 order-md-2">
          <div className="row justify-content-center">
            ...
            <div className="col-10 col-lg-8 mb-5 mb-md-0 con">
              ...
              <p className="lead">
                I don't like to give descriptions or titles to my works for the viewer to create a unique personal connection with scene.
              </p>
            </div>
